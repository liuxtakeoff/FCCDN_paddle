...
class mc_dice_bce_loss(nn.Layer):
    """multi-class"""
...
def FCCDN_loss_SCD(scores, labels):
    ...
    pred_seg_pre_unchange = paddle.argmax(scores[1], axis=1)
    pred_seg_post_unchange = paddle.argmax(scores[2], axis=1)
