...
@time_it
def split_data(image_path, mask_path, block_size, save_dir,overlap_ratio=0.0):
    ...
    rows = ceil(image.height / block_size / (1-overlap_ratio))
    cols = ceil(image.width / block_size / (1-overlap_ratio))
